...
pres_2017_R1_communes <- read_excel("./définitifs/Presidentielle_2017_Resultats_Communes_Tour_1_c.xls", skip = 3, guess_max = 36000)
...
write_excel_csv(pres_2017_R1_communes_cleaned, path = "./Presidentielle_2017_Resultats_Communes_T1_clean_def.csv")
