...
pres_2017_R1_cantons <- read_excel("./définitifs/Presidentielle_2017_Resultats_Tour_1_c.xls", skip = 3, guess_max = 2100, sheet = "Canton Tour 1")

pres_2017_R1_cantons_cleaned <- lire(pres_2017_R1_cantons, keep = c("Code du département", "Libellé du département", "Code du canton", "Libellé du canton", "Inscrits", "Abstentions", "Exprimés", "Blancs", "Nuls"), col = seq(21, 91, 7), gap = 2)
...
write_excel_csv(pres_2017_R1_cantons_cleaned, path = "./Presidentielle_2017_Resultats_Cantons_T1_clean_def.csv")
