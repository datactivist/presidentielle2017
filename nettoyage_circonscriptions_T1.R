...
pres_2017_R1_circonscriptions <- read_excel("./Presidentielle_2017_Resultats_Tour_1.xls", skip = 3, guess_max = 600, sheet = "Circo. Leg. Tour 1")
...
write_excel_csv(pres_2017_R1_circonscriptions_cleaned, path = "./Presidentielle_2017_Resultats_Circonscription_T1_clean.csv")
