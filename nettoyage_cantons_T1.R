...
pres_2017_R1_cantons <- read_excel("./Presidentielle_2017_Resultats_Tour_1.xls", skip = 3, guess_max = 2100, sheet = "Canton Tour 1")
...
write_excel_csv(pres_2017_R1_cantons_cleaned, path = "./Presidentielle_2017_Resultats_Cantons_T1_clean.csv")
