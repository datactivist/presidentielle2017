...
pres_2017_R1_circonscriptions <- read_excel("./définitifs/Presidentielle_2017_Resultats_Tour_1_c.xls", skip = 3, guess_max = 600, sheet = "Circo. Leg. Tour 1")

pres_2017_R1_circonscriptions_cleaned <- lire(pres_2017_R1_circonscriptions, keep = c("Code du département", "Libellé du département", "Code de la circonscription", "Libellé de la circonscription", "Inscrits", "Abstentions", "Exprimés", "Blancs", "Nuls"), col = seq(21, 91, 7), gap = 2)
...
write_excel_csv(pres_2017_R1_circonscriptions_cleaned, path = "./Presidentielle_2017_Resultats_Circonscription_T1_clean_def.csv")
