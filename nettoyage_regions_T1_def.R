...
pres_2017_R1_regions <- read_excel("./définitifs/Presidentielle_2017_Resultats_Tour_1_c.xls", skip = 3, guess_max = 25, sheet = "Régions Tour 1")

pres_2017_R1_regions_cleaned <- lire(pres_2017_R1_regions, keep = c("Code de la région", "Libellé de la région", "Inscrits", "Abstentions", "Exprimés", "Blancs", "Nuls"), col = seq(18, 78, 6), gap = 2)
...
write_excel_csv(pres_2017_R1_regions_cleaned, path = "./Presidentielle_2017_Resultats_Région_T1_clean_def.csv")
