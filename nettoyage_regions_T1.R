...
pres_2017_R1_regions <- read_excel("./Presidentielle_2017_Resultats_Tour_1.xls", skip = 3, guess_max = 25, sheet = "Régions Tour 1")
...
write_excel_csv(pres_2017_R1_regions_cleaned, path = "./Presidentielle_2017_Resultats_Région_T1_clean.csv")
