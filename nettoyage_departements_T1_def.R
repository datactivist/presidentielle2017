...
pres_2017_R1_departements <- read_excel("./définitifs/Presidentielle_2017_Resultats_Tour_1_c.xls", skip = 3, guess_max = 25, sheet = "Départements Tour 1")
...
write_excel_csv(pres_2017_R1_departements_cleaned, path = "./Presidentielle_2017_Resultats_Département_T1_clean_def.csv")
